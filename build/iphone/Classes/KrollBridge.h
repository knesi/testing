...
@interface SZJaegercorpsObject : KrollCoverageObject {
#else
@interface SZJaegercorpsObject : KrollObject {
#endif
@private
...
extern NSString * SZJaegercorps$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	SZJaegercorpsObject *_szjaegercorps;
	BOOL shutdown;
