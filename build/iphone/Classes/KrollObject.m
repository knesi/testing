 ...
 * Copyright (c) 2009-2011 by SZJaegercorps, Inc. All Rights Reserved.
...
//@interface SZJaegercorpsObject : NSObject
//@end

@interface SZJaegercorpsObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[SZJaegercorpsObject class]])
		{
			for (NSString *key in [[(SZJaegercorpsObject*)o modules] allKeys])
			{
