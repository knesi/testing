...
// in simulator we redefine to format for SZJaegercorps Developer console
...
{\
	NSString * exceptionName = [@"org.szjaegercorps." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.szjaegercorps";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UISZJaegercorpsNativeItemNone = -1, 
	UISZJaegercorpsNativeItemSpinner = -2,
	UISZJaegercorpsNativeItemProgressBar = -3,
	
	UISZJaegercorpsNativeItemSlider = -4,
	UISZJaegercorpsNativeItemSwitch = -5,
	UISZJaegercorpsNativeItemMultiButton = -6,
	UISZJaegercorpsNativeItemSegmented = -7,
	
	UISZJaegercorpsNativeItemTextView = -8,
	UISZJaegercorpsNativeItemTextField = -9,
	UISZJaegercorpsNativeItemSearchBar = -10,
	
	UISZJaegercorpsNativeItemPicker = -11,
	UISZJaegercorpsNativeItemDatePicker = -12,
	
	UISZJaegercorpsNativeItemInfoLight = -13,
	UISZJaegercorpsNativeItemInfoDark = -14,
	
	UISZJaegercorpsNativeItemDisclosure = -15,
	
	UISZJaegercorpsNativeItemContactAdd = -16
};
